...
public class BallistixBlocks {
	...
	public static final DeferredHolder<Block, GenericMachineBlock> BLOCK_RADAR = BLOCKS.register("radar", () -> new GenericMachineBlock(TileRadar::new, BallistixVoxelShapes.RADAR));

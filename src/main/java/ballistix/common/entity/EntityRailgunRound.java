...
public class EntityRailgunRound extends Entity {
    ...
    public void tick() {
        ...
        // this is slightly less efficient, but solves the issue of passing through blocks
        ...
        for (int i = 0; i < speed; i++) {
            ...
            if(isServer) {
                ...
                if (selected != null) {
                    selected.hurt(selected.damageSources().source(BallistixDamageTypes.RAILGUN_ROUND), 20);
                    removeAfterChangingDimensions();
                }
            }
